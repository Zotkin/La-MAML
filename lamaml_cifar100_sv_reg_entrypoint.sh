...
##### La-MAML #####
python3 main.py $CIFAR --model lamaml_cifar --expt_name "lamaml_cifar_sv_reg_with_ratio_norm_memories_10_seed_$1" --memories 10 --batch_size 10 --replay_batch_size 10 --n_epochs 10 \
