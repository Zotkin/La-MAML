...
##### La-MAML #####
##### La-MAML #####
python3 main.py $IMGNET --model lamaml_cifar --expt_name lamaml_tinyimagenet_sv_reg_entropy_$1 --memories 400 --batch_size 10 --replay_batch_size 10 --n_epochs 10 \
                    ...
                    --seed $SEED --grad_clip_norm 1.0 --calc_test_accuracy --validation 0.1 --use-sv-regularization --ratio-factor $1
